 ...
 * CONSTANTS
 */
// Simple BLE Periperal Events


// Simple BLE Peripheral Task Events
#define SBP_START_DEVICE_EVT                            0x0001
#define SBP_PERIODIC_EVT                                0x0002
#define SBP_LONGTERM_UPDATE_EVT                         0x0004
#define SBP_TEST_INT_EVT                                0x0008
#define SBP_AFE_INT_EVT                                 0x0010
   
/*********************************************************************
 * MACROS
 */
 
#define LED_ENABLE()            (P1_1 = 1)
#define LED_DISABLE()           (P1_1 = 0)
...
void waitUs( uint16 time );

void waitMs( uint16 msec );

void toggleTestGpio( uint8 Testpin );
